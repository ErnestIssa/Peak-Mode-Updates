...
const AccessoriesCollection = () => {
  ...
  // Filter categories for accessories collection
  const categories = [
    { id: 'all', name: 'All Accessories' },
    { id: 'socks', name: 'Performance Socks' },
    { id: 'bags', name: 'Training Bags' },
    { id: 'hats', name: 'Caps & Hats' },
    { id: 'gloves', name: 'Training Gloves' },
  ...
  const accessoriesProducts = testProducts;
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl font-medium mb-8 max-w-2xl mx-auto">
            Details That Elevate the Grind.
          </p>
          <p className="text-lg md:text-xl opacity-90 max-w-3xl mx-auto leading-relaxed">
            The right tools amplify the mission.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            From performance socks to training essentials, our accessories are designed to support your journey — every rep, every step. Complete your Peak Mode setup with gear that doesn't just complement your performance, it enhances it.
          </p>
        </div>
      </section>
      ...
      <section className="bg-black text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Explore our best-selling accessories and discover what completes Peak Mode athletes.
          </p>
