              ...
              <div>
                ...
                <div className="mt-12">
                  ...
                  <div className="flex space-x-4">
                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-secondary hover:bg-secondary/80 transition-colors">
                      <svg 
                        className="w-5 h-5"
                    ...
                    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-secondary hover:bg-secondary/80 transition-colors">
                      <svg 
                        className="w-5 h-5"
                        xmlns="http://www.w3.org/2000/svg" 
                        viewBox="0 0 24 24" 
                    ...
                    <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-secondary hover:bg-secondary/80 transition-colors">
                      <svg 
                        className="w-5 h-5"
                        xmlns="http://www.w3.org/2000/svg" 
                        viewBox="0 0 256 256" 
                        fill="currentColor"
                      >
                        <path d="M224 64.69a63.82 63.82 0 0 1-38.62-12.79A63.91 63.91 0 0 1 144 0h-32v168a24 24 0 1 1-24-24 23.91 23.91 0 0 1 8 1.38V105.66a56 56 0 1 0 40 54.34V96.67a95.57 95.57 0 0 0 48 12.66V80.73c3.3.29 6.63.45 10 .45h10Z"/>
                      </svg>
                    </a>
                  </div>
                </div>
