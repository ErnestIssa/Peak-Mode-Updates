...
const MensCollection = () => {
  ...
  // Filter categories for men's collection
  const categories = [
  ...
  const mensProducts = testProducts;
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg md:text-xl opacity-90 max-w-3xl mx-auto leading-relaxed">
            Gear built for power, precision, and performance.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Every piece in our men's range is crafted to keep up with your grind — from gym floor intensity to street-level comfort. No flash. Just functional gear that fuels your Peak Mode.
          </p>
        </div>
      </section>
      ...
      <section className="bg-black text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Explore our best-selling men's gear and discover what drives Peak Mode athletes.
          </p>
