      ...
      <main className="pt-20">
        ...
        <div className="h-96 bg-black relative flex items-center justify-center">
          <div className="absolute inset-0 opacity-50" style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?ixlib=rb-4.0.3&auto=format&fit=crop&w=1400&q=80')",
            backgroundSize: "cover",
            backgroundPosition: "center"
          }}></div>
          <div className="text-center text-white relative z-10 px-4">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">Women's Collection</h1>
            <p className="text-xl max-w-2xl mx-auto">Empowering performance for every workout</p>
          </div>
        </div>
          ...
          <div className="peak-container">
            <div className="text-center mb-12">
              ...
              <p className="mt-6 text-lg max-w-3xl mx-auto text-muted-foreground">
                Premium activewear that combines style, comfort, and performance for your fitness journey.
              </p>
            </div>
                  ...
                  womensProducts.map((product, index) => (
                    ...
                    >
                      <ProductCard
                        ...
                        category={product.category_name || "Women's Wear"}
                      />
                    </div>
                  ))
                ) : (
